<%-- 
    Document   : vendorList
    Created on : 2 May, 2018, 12:33:28 PM
    Author     : manish
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 scrollable">
                                            <table class="table datatable table-bordered" id="tableId">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${vendorList}" var="item">
                                                        ...
                                                        <tr class="<c:out value='${rowClass}'/> "  data-vendor-id="${item.vendorId}">
                                                            <td><c:out value="${item.vendorId}"/></td>
                    ...
                    <!-- edit form page-->
                    <form name="form2" id="form2" action="../vendor/showEditVendor.htm" method="post">
                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />        
                        <input type="hidden" id="vendorId" name="vendorId"/>
                    </form>
                </div>
                <!-- END PAGE CONTENT WRAPPER -->
                <form name="form1" id="form1" action="../vendor/activeVendor.htm" method="POST">
                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                    <input type="hidden" id="vendorIds" name="vendorIds"/>
        ...
        <script type="text/javascript" defer="defer">
            ...
            function editFunction(vendorId) {
