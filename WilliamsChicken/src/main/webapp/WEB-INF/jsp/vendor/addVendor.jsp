<%-- 
    Document   : addVendor
    Created on : 2 May, 2018, 12:28:00 PM
    Author     : manish
--%>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" action="addVendor.htm" commandName="vendor" method="POST" name="form1" id="form1">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <form:select path="stateId" id="stateId" cssClass="form-control select" data-live-search="true">
