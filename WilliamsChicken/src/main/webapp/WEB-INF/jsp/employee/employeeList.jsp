<%-- 
    ...
    Created on : 5 May, 2018, 8:57:01 PM
    Author     : manish
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                                            ...
                                            <table class="table datatable table-bordered" id="tableId">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${employeeList}" var="item">
                                                        ...
                                                        <tr class="<c:out value='${rowClass}'/> clickableRow"  data-employee-id="${item.employeeId}">
                                                            ...
                                                            <td><a href="#" title="Edit Employee" onclick="editFunction(${item.employeeId});"><spna class="fa fa-pencil"></spna> Edit</a></td>   
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
                    ...
                    <!-- edit form page-->
                    <form name="form2" id="form2" action="../employee/showEditEmployee.htm" method="post">
            ...
            <!-- END PAGE CONTENT -->
            <form name="form1" id="form1" action="../employee/activeEmployee.htm" method="POST">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
        ...
        <script type="text/javascript" defer="defer">
            ...
            function editFunction(employeeId) {
